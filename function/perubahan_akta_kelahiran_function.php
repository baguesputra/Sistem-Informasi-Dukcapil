...
class perubahan_akta_kelahiran {

    public function index() 
    { 
        $koneksi = new koneksi();
        $conn =  $koneksi->get_connection();
        $data=mysqli_query($conn,"SELECT perubahan_akta_kelahiran.id, akta_kelahiran.no_akta, akta_kelahiran.nama, perubahan_akta_kelahiran.tgl_pengubahan, perubahan_akta_kelahiran.perubahan, perubahan_akta_kelahiran.akta_awal, perubahan_akta_kelahiran.akta_perubahan, akta_kelahiran.ayah, akta_kelahiran.ibu, perubahan_akta_kelahiran.status FROM perubahan_akta_kelahiran join akta_kelahiran on perubahan_akta_kelahiran.no_akta = akta_kelahiran.id"); 
    ...
    { 
        ...
        $dirUpload = "../../arsip/perubahan akta kelahiran/";
        ...
        $dirUpload2 = "../../arsip/perubahan akta kelahiran/";
        $terupload2 = move_uploaded_file($namaSementara2, $dirUpload2.$namaFile2);

        $file_perubahan = $namaFile2;
        ...
        $sql = "INSERT INTO perubahan_akta_kelahiran 
    ...
    { 
        $koneksi = new koneksi();
        $conn =  $koneksi->get_connection();
        $sql = "SELECT * FROM perubahan_akta_kelahiran WHERE id='$id'";
        $bind = $conn->query($sql);
    ...
    public function update($id,$no_akta,$tgl_pengajuan,$tgl_pengubahan,$perubahan,$alasan,$updated_by,$status)
    {
        $koneksi = new koneksi();
        $conn =  $koneksi->get_connection();

      
        $sql = "UPDATE perubahan_akta_kelahiran SET no_akta='$no_akta', tgl_pengajuan='$tgl_pengajuan', 
    ...
    { 
        $koneksi = new koneksi();
        $conn =  $koneksi->get_connection();
        $sql = "DELETE FROM perubahan_akta_kelahiran WHERE id='$id'";
        $conn->query($sql);
    } 
    ...
    { 
        $koneksi = new koneksi();
        $conn =  $koneksi->get_connection();
        $sql = "UPDATE perubahan_akta_kelahiran SET status='$status' WHERE id='$id'";
        $conn->query($sql);
    } 
    ...
    public function upload($id,$surat_akta)
    {
        ...
        $sql = "UPDATE perubahan_akta_kelahiran SET surat_akta='$file_awal' WHERE id='$id'";
        $conn->query($sql);
    }
}
?>
