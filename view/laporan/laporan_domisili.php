        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form id="quickForm" name="form" action="pdf/pdf_domisili.php" method="GET">
                <div class="card-body">
                ...
                <div class="card-footer">
                  ...
                  <input type='submit' class="btn btn-success" value='Excel' onclick="form.action='excel/excel_domisili.php';  return true;">
                </div>
              </form>
            </div>
            </div>
