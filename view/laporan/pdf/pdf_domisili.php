...
<img src="../../../asset/img/logo_laporan2.png" style="position: absolute; width: 150px; height: 120px;margin-left:-30px;margin-top:10px;"> 
    ...
    <hr class="line-title">
    <div class="teks">
   <h3 align="center">Laporan Rekap Domisili</h3>
   ...
   <thead>
                  ...
                  <?php
                    ...
                    $data=mysqli_query($conn,"SELECT domisili.id, domisili.tanggal, penduduk.no_penduduk, penduduk.nama, domisili.status FROM domisili join penduduk on domisili.id_penduduk = penduduk.id WHERE domisili.tanggal BETWEEN '".$tglawal."' AND '".$tglakhir."' order by domisili.status desc"); 
                    while($domisili = mysqli_fetch_array($data)){
