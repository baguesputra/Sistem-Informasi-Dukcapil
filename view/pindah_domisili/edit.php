              ...
              <form id="quickForm" action="proses.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tanggal" class="form-control" id="exampleInputPassword1" value="<?= $pindah_domisili->tanggal ?>" placeholder="Masukkan Tanggal Lahir">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Alamat Tujuan Pindah</label>
                    <input type="text" name="alamat_tujuan" class="form-control" id="exampleInputPassword1" value="<?= $pindah_domisili->alamat_tujuan ?>" placeholder="Masukkan Alamat Tujuan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Alasan</label>
                    <input type="text" name="alasan" class="form-control" id="exampleInputPassword1" value="<?= $pindah_domisili->alasan ?>" placeholder="Masukkan Alasan">
                  </div>
                  <input type="hidden" name="status" class="form-control" id="exampleInputPassword1" value="<?= $pindah_domisili->status ?>" placeholder="Masukkan Agenda">
