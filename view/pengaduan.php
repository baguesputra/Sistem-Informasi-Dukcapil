...
<div class="row featurette">
  <div class="col-md-7">
    <h2 class="featurette-heading">Pengaduan</h2> </div>
...
<form method="post" action="proses_pengaduan.php">
  ...
  <div class="form-outline mb-4">
    <textarea class="form-control" name="pengaduan" id="form6Example7" rows="4"></textarea>
    <label class="form-label" for="form6Example7">Pengaduan</label>
  </div>

  <button type="submit" name="pengaduan" class="btn btn-primary btn-block mb-4">Kirim</button>
</form>
</div>
</main>
