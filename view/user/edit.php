                ...
                <div class="form-group">
                    ...
                    <select name="kepala_keluarga" id="kepala_keluarga" class="form-control">
                      <?php foreach ($data->penduduk() as $penduduk): {?>
                        <?php if($penduduk['no_penduduk'] == $user->id_penduduk){?>
                        <option value="<?= $user->no_penduduk ?>" selected hidden><?= $penduduk['no_penduduk']; ?> - <?= $penduduk['nama']; ?></option>
                        <?php } ?>
                      <option value="<?= $penduduk['no_penduduk']; ?>"><?= $penduduk['no_penduduk']; ?> - <?= $penduduk['nama']; ?></option>
                      <?php } endforeach ?>
                    </select>
                  </div>
                  <div class="f
