...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Detail Akta Perkawinan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Data Akta Perkawinan</a></li>
              <li class="breadcrumb-item active">Detail Akta Perkawinan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form id="quickForm" action="proses.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <input type="text" name="id" class="form-control" id="exampleInputEmail1" value="<?= $akta_perkawinan->id ?>" placeholder="Masukkan No Akta" hidden>
                    ...
                    <input type="text" name="no" class="form-control" id="exampleInputEmail1" value="<?= $akta_perkawinan->no ?>" placeholder="Masukkan No Akta" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Pria</label>
                    <select name="nama_pria" id="nama_pria" class="form-control"readonly >
                  ...
                  <div class="form-group">
                    ...
                    <select name="nama_wanita" id="nama_wanita" class="form-control"readonly >
                      <?php foreach ($data->penduduk() as $penduduk): {?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tgl_nikah" class="form-control" id="exampleInputPassword1" value="<?= $akta_perkawinan->tgl_nikah ?>" placeholder="Masukkan Tanggal Lahir" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tempat Nikah</label>
                    <input type="text" name="tempat_nikah" class="form-control" id="exampleInputPassword1" value="<?= $akta_perkawinan->tempat_nikah ?>" placeholder="Masukkan Tempat Lahir" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Dibuat</label>
                    <input type="date" name="tgl_dibuat" class="form-control" id="exampleInputPassword1" value="<?= $akta_perkawinan->tgl_dibuat ?>" placeholder="Masukkan Tanggal Dibuat" readonly>
                  </div>
                  <?php foreach ($data->penduduk() as $penduduk) {?>
