...
<img src="../../asset/img/logo_laporan.jpg" style="position: absolute; width: 100px; height: auto;"> 
    ...
    <hr class="line-title">
    <div class="teks">
   <h3 align="center"><u>Surat Perintah Perjalanan Dinas </u><br>SPPD</h3>
   ...
   <?php
     ...
     <tbody>
      <tr>
       ...
       <td width="150px">1. Nama Pegawai yang diperintah</td>
       <td width="10px"> <?= $p['nik'] ?> <?= $p['nama'] ?></td>
         
       </tr>
       <tr>
       <td width="150px">2. Pangkat</td>
       <td width="10px"> <?= $p['golongan'] ?> <?= $p['tingkat'] ?> <?= $p['ket'] ?> </td>
       ...
       <td width="130px">4. Maksud dan Tujuan</td>
       <td width="200px"> <?= $spd->tujuan ?></td>
       </tr>
       <tr>

       <td width="130px">5. Pada Tanggal</td>
       <td width="10px"><?= date('d M Y',strtotime($spd->tgl)) ?> </td>
       </tr>
       <tr>

       <td width="130px">6. Bertempat</td>
