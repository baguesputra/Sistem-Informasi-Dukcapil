...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lihat Perubahan Akta Keluarga</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Data Perubahan Akta Keluarga</a></li>
              <li class="breadcrumb-item active">Lihat Perubahan Akta Keluarga</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form id="quickForm" action="proses.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tgl_pengajuan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_keluarga->tgl_pengajuan ?>" placeholder="Masukkan Nama" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Pengubahan</label>
                    <input type="date" name="tgl_pengubahan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_keluarga->tgl_pengubahan ?>" placeholder="Masukkan Tanggal Lahir"readonly >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Perubahan</label>
                    <input type="text" name="perubahan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_keluarga->perubahan ?>" placeholder="Masukkan Perubahan"readonly >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Alasan</label>
                    <input type="text" name="alasan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_keluarga->alasan ?>" placeholder="Masukkan Alasan" readonly>
                  </div>
                  <div class="form-group">
