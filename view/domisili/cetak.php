...
<img src="../../asset/img/logo_laporan2.png" style="position: absolute; width: 150px; height: 120px;margin-left:-30px;margin-top:10px;"> 
  ...
  <style>
   ...
   <br>
  <p style="font-size:15px">Yang nama nya tersebut benar bahwa berdomisili diwilayah kami. Demikian Surat Keterangan ini dibuat dengan sebenarnya dan
dapat dipergunakan dengan semestinya.</p>
