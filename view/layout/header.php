...
?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../view/index.php" class="nav-link">Dinas Kependudukan dan Pencatatan Sipil Kota Banjarmasin</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="../view/index.php" class="brand-link">
      <img src="../asset/img/logo_dprd.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
