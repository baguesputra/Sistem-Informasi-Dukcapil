...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lihat Perubahan Akta perkawinan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Data Perubahan Akta perkawinan</a></li>
              <li class="breadcrumb-item active">Lihat Perubahan Akta perkawinan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <input type="text" name="id" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_perkawinan->id ?>" placeholder="Masukkan Nama" hidden>
                    ...
                    <select name="no_akta" id="no_akta" class="form-control" readonly>
                      ...
                      <?php foreach ($data->akta_perkawinan() as $akta_perkawinan): {?>
                        ...
                        <?php } ?>
                      <option value="<?= $akta_perkawinan['id']; ?>"><?= $akta_perkawinan['no_akta']; ?></option>
                      <?php } endforeach ?>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Pengajuan</label>
                    <input type="date" name="tgl_pengajuan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_perkawinan->tgl_pengajuan ?>" placeholder="Masukkan Nama" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Pengubahan</label>
                    <input type="date" name="tgl_pengubahan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_perkawinan->tgl_pengubahan ?>" placeholder="Masukkan Tanggal Lahir"readonly >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Perubahan</label>
                    <input type="text" name="perubahan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_perkawinan->perubahan ?>" placeholder="Masukkan Perubahan"readonly >
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Alasan</label>
                    <input type="text" name="alasan" class="form-control" id="exampleInputPassword1" value="<?= $perubahan_akta_perkawinan->alasan ?>" placeholder="Masukkan Alasan" readonly>
                  </div>
                  <div class="form-group">
